package es.ibrands.torrats.data;

import android.net.Uri;

public class ItemsContract
{
	public static final String CONTENT_AUTHORITY = "es.ibrands.torrats";
	public static final Uri BASE_URI = Uri.parse("content://es.ibrands.torrats");
	...
	{
		public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.es.ibrands.torrats.items";
		public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.es.ibrands.torrats.items";
