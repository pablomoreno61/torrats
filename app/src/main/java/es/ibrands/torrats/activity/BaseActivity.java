...
public abstract class BaseActivity extends AppCompatActivity implements MenuItem.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        super.setContentView(R.layout.base_activity);// The base layout that contains your navigation drawer.
    ...
    public boolean onMenuItemClick(MenuItem item)
    {
        ...
        Log.d("base", String.valueOf(item.getItemId()));
        switch (item.getItemId()) {
            ...
            case R.id.nav_photo_gallery:
                intent = new Intent(this, PhotoGalleryListActivity.class);
                startActivity(intent);
                break;
        }
        return false;
